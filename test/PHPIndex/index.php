...
//echo '<h1>Bonjour,c\'est '.$nom.' !</h1>'; // Utilisation de variables dans une chaîne
// uitliser backSlash \ pour ignorer le fait que ce n'est pas une commande ou fin de commande
// // --- 3. Les constantes ---

 //define("PI", 3.14159); // Définition d'une constante
 //const SITE_NAME = "MonSite"; // Définition avec const
...
// require("fichier.php"); // Inclure un fichier (plante en cas d'erreur)
...
echo "Bonjour, je m'appelle " . $prenom . " " . $nom . " et j'ai " . ($age + 5) . " ans.";
